...
import { h, markRaw, nextTick, Transition, type App } from 'vue'

import { resetZIndex } from '@moe-ui/hooks'
import MessageBox from './MessageBox.vue'
import { MESSAGE_BOX_CLOSE_ICON, MESSAGE_BOX_DEFAULT_OPTIONS } from './constants'
import { MoeMessageBox, messageBoxInstances } from './method'
...
describe('MoeMessageBox method', () => {
  ...
  it('moves focus into message box so Enter confirms instead of retriggering opener', async () => {
    ...
    const confirmButton = [...document.body.querySelectorAll<HTMLButtonElement>('.moe-button')].at(
      -1
    )
