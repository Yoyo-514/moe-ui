...
import { h, markRaw, nextTick, Transition } from 'vue'

import Notification from './Notification.vue'
import { MoeNotification, notificationInstances } from './method'
import { NOTIFICATION_GAP, NOTIFICATION_HEIGHT } from './constants'
...
describe('MoeNotification method', () => {
  ...
  it('installs $notification and supports calling from component instance', async () => {
    ...
    MoeNotification.install(app as never)
